    ...
    <div id="base" class="">
      ...
      <div id="u19" class="ax_default">
        ...
        <div id="u20" class="ax_default">
          ...
          <!-- Unnamed (矩形) -->
          <div id="u21" class="ax_default _形状1">
          ...
          <!-- 搜索框 (文本框) -->
          <div id="u23" class="ax_default _文本框1" data-label="搜索框">
            <input id="u23_input" type="search" value="课程名称、老师名称"/>
          </div>

          <!-- Unnamed (矩形) -->
          <div id="u24" class="ax_default _形状1">
      ...
      <!-- ImagePanel (动态面板) -->
      <div id="u31" class="ax_default" data-label="ImagePanel">
        ...
        <div id="u31_state3" class="panel_state" data-label="State4">
          <div id="u31_state3_content" class="panel_state_content">
          </div>
        </div>
        <div id="u31_state4" class="panel_state" data-label="State5">
          <div id="u31_state4_content" class="panel_state_content">
          </div>
        </div>
        <div id="u31_state5" class="panel_state" data-label="State6">
          <div id="u31_state5_content" class="panel_state_content">
          </div>
        </div>
        <div id="u31_state6" class="panel_state" data-label="State7">
          <div id="u31_state6_content" class="panel_state_content">
          </div>
        </div>
      </div>

      <!-- LoopPanel (动态面板) -->
      <div id="u32" class="ax_default" data-label="LoopPanel">
        <div id="u32_state0" class="panel_state" data-label="State1">
          <div id="u32_state0_content" class="panel_state_content">
          </div>
        </div>
        <div id="u32_state1" class="panel_state" data-label="State2">
          <div id="u32_state1_content" class="panel_state_content">
          </div>
        </div>
        <div id="u32_state2" class="panel_state" data-label="State3">
          <div id="u32_state2_content" class="panel_state_content">
          </div>
        </div>
        <div id="u32_state3" class="panel_state" data-label="State4">
          <div id="u32_state3_content" class="panel_state_content">
          </div>
        </div>
        <div id="u32_state4" class="panel_state" data-label="State5">
          <div id="u32_state4_content" class="panel_state_content">
          </div>
        </div>
        <div id="u32_state5" class="panel_state" data-label="State6">
          <div id="u32_state5_content" class="panel_state_content">
          </div>
        </div>
        <div id="u32_state6" class="panel_state" data-label="State7">
          <div id="u32_state6_content" class="panel_state_content">
          </div>
        </div>
      </div>

      <!-- State1 (矩形) -->
      <div id="u33" class="ax_default box_2" data-label="State1" selectiongroup="ImageIndex">
      ...
      <!-- State2 (矩形) -->
      <div id="u35" class="ax_default box_2" data-label="State2" selectiongroup="ImageIndex">
      ...
      <!-- State3 (矩形) -->
      <div id="u37" class="ax_default box_2" data-label="State3" selectiongroup="ImageIndex">
      ...
      <!-- State4 (矩形) -->
      <div id="u39" class="ax_default box_2" data-label="State4" selectiongroup="ImageIndex">
      ...
      <!-- State5 (矩形) -->
      <div id="u41" class="ax_default box_2" data-label="State5" selectiongroup="ImageIndex">
      ...
      <!-- State6 (矩形) -->
      <div id="u43" class="ax_default box_2" data-label="State6" selectiongroup="ImageIndex">
      ...
      <!-- State7 (矩形) -->
      <div id="u45" class="ax_default box_2" data-label="State7" selectiongroup="ImageIndex">
      ...
      <div id="u49" class="ax_default">
        ...
        <div id="u52" class="ax_default box_1">
          ...
          <div id="u53" class="text" style="visibility: visible;">
            <p style="font-size:20px;text-align:center;"><span>C语言程序设计</span></p><p style="font-size:28px;text-align:left;"><span>&nbsp;&nbsp;&nbsp; </span><span style="font-size:16px;color:#999999;">一起欣赏C语言之美，领悟C语言之妙，体会学习C语言之无穷乐趣</span></p>
          </div>
        </div>
      </div>
      ...
      <div id="u54" class="ax_default">
        ...
        <div id="u55" class="ax_default image">
          <img id="u55_img" class="img " src="images/home/u13.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u59" class="ax_default line">
          <img id="u59_img" class="img " src="images/home/u17.png"/>
          <!-- Unnamed () -->
      ...
      <div id="u61" class="ax_default">
        ...
        <div id="u62" class="ax_default image">
          <img id="u62_img" class="img " src="images/home/u62.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u64" class="ax_default box_1">
          ...
          <div id="u65" class="text" style="visibility: visible;">
            <p style="font-size:20px;text-align:center;"><span>金融学基础</span></p><p style="font-size:28px;text-align:left;"><span>&nbsp;&nbsp;&nbsp; </span><span style="font-size:16px;color:#999999;">全面了解现代金融学的框架体系，建立金融分析的思维与逻辑</span></p>
          </div>
        </div>
      </div>
      ...
      <div id="u66" class="ax_default">
        ...
        <div id="u67" class="ax_default image">
          <img id="u67_img" class="img " src="images/home/u67.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u69" class="ax_default box_1">
          ...
          <div id="u70" class="text" style="visibility: visible;">
            <p style="font-size:20px;text-align:center;"><span>创业之路——带你玩转商业模式</span></p><p style="font-size:28px;text-align:left;"><span>&nbsp;&nbsp;&nbsp; </span><span style="font-size:16px;color:#999999;">寓学于玩，博览现代商业模式，助你在创业之旅上乘风破浪，一路前行</span></p>
          </div>
        </div>
      </div>
      ...
      <div id="u71" class="ax_default">
        ...
        <!-- Unnamed (矩形) -->
        <div id="u72" class="ax_default sticky_2">
      ...
      <!-- MessageText (矩形) -->
      <div id="u76" class="ax_default label ax_default_hidden" data-label="MessageText" style="display: none; visibility: hidden">
      ...
      <!-- MessageText (矩形) -->
      <div id="u78" class="ax_default label ax_default_hidden" data-label="MessageText" style="display: none; visibility: hidden">
      ...
      <!-- MessageText (矩形) -->
      <div id="u80" class="ax_default label ax_default_hidden" data-label="MessageText" style="display: none; visibility: hidden">
      ...
      <!-- MessageText (矩形) -->
      <div id="u82" class="ax_default label ax_default_hidden" data-label="MessageText" style="display: none; visibility: hidden">
      ...
      <!-- MessageText (矩形) -->
      <div id="u84" class="ax_default label ax_default_hidden" data-label="MessageText" style="display: none; visibility: hidden">
      ...
      <div id="u86" class="ax_default sticky_2">
        ...
        <div id="u87" class="text" style="visibility: visible;">
          <p style="font-size:18px;"><span style="font-family:'Arial Normal', 'Arial';font-weight:400;color:#FFFFFF;"><br></span></p><p style="font-size:36px;"><span style="font-family:'方正姚体 Bold', '方正姚体';font-weight:700;color:#FFFFFF;"><br></span></p><p style="font-size:36px;"><span style="font-family:'方正姚体 Bold', '方正姚体';font-weight:700;color:#FFFFFF;">&nbsp;&nbsp; &nbsp;&nbsp; </span><span style="font-family:'方正姚体 Bold', '方正姚体';font-weight:700;color:#00CCFF;">UP在线学习平台</span></p><p style="font-size:18px;"><span style="font-family:'Arial Normal', 'Arial';font-weight:400;color:#FFFFFF;">中国石油大学（华东）UP学习平台。与优秀讲师、专业机构、院校合作，</span></p><p style="font-size:18px;"><span style="font-family:'Arial Normal', 'Arial';font-weight:400;color:#FFFFFF;">为您提供海量优质课程，以及创新的在线学习体验，帮助您获得全新的</span></p><p style="font-size:18px;"><span style="font-family:'Arial Normal', 'Arial';font-weight:400;color:#FFFFFF;">个人发展和能力提升。</span></p>
        </div>
      </div>
      ...
      <div id="u88" class="ax_default box_2">
        ...
        <div id="u89" class="text" style="visibility: visible;">
          <p><span>关于我们</span></p><p><span><br></span></p><p><span>联系我们</span></p><p><span><br></span></p><p><span>帮助中心</span></p>
        </div>
      </div>
      ...
      <div id="u90" class="ax_default box_2">
        ...
        <div id="u91" class="text" style="visibility: visible;">
          <p><span><a href="sykc.aspx">所有课程</a></span></p>
        </div>
      </div>

      <!-- Unnamed (矩形) -->
      <div id="u92" class="ax_default box_1">
        <div id="u92_div" class="">
            <asp:TextBox ID="TextBox1" runat="server" Height="194px" Width="1071px"></asp:TextBox>
          </div>
        <!-- Unnamed () -->
      ...
      <div id="u94" class="ax_default box_3">
        ...
        <div id="u95" class="text" style="visibility: visible;">
          <p><span>亲爱的 &nbsp<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></span></p>
        </div>
      </div>
    </div>
      </form>
